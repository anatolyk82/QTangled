...
MyPage {
        ...
        Rectangle {
            ...
            Behavior on scale {
                SequentialAnimation {
                    ...
                    ScriptAction {
                        script: {
                            app.currentPage = "PageInvLinesGame.qml"
                        }
                    }
                }
            }
                ...
                Rectangle {
                    ...
                    Column {
                        ...
                        Label {
                            ...
                            font.pixelSize: 0.18*rootWrapper.height
                        }
                        Row {
                            spacing: 5*app.dp
                            Image {
    ...
    function isLevelLock( index, time ) {
        ...
        if( index == 0 ) {
            ...
            var prev_time = invLinesGameLevels.get((index-1)).time_ms
            if( prev_time != 0 ) {
                return false
            } else {
                return true
